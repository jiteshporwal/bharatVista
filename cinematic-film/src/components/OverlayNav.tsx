...
export default function OverlayNav({ onBookSeatClick }: OverlayNavProps) {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#061727]/98 border-b border-white/10 px-6 py-6 space-y-4 text-sm font-medium animate-fadeIn">
          <Link
            href="/"
            onClick={() => setMobileMenuOpen(false)}
            className="block text-zinc-200 hover:text-amber-300 py-1"
          >
            Home
          </Link>
          <Link
          ...
          <div className="pt-3 border-t border-white/10 flex flex-col gap-2">
            <button
              ...
              className="w-full py-3 rounded-full font-semibold text-white bg-gradient-to-r from-[#EA580C] to-[#C2410C] flex items-center justify-center gap-2"
            >

...
export default function ComingSoonJourneys() {
  ...
  return (
    <section id="coming-soon" className="relative py-28 bg-[#040e1a] border-y border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <span className="inline-block text-xs uppercase tracking-widest text-amber-300/80 bg-white/5 border border-white/10 px-4 py-1 rounded-full font-mono">
            Notice: The concepts below are currently in curation and are COMING SOON
          </span>
        </div>

        {/* Featured Flagship Coming Soon: PACHMARHI (Large Cinematic Feature) */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative rounded-3xl overflow-hidden bg-[#0A2E4C]/50 border border-white/15 shadow-2xl mb-10 grid grid-cols-1 lg:grid-cols-12"
        >
          {/* Visual (7 cols) */}
          <div className="lg:col-span-7 relative min-h-[380px] sm:min-h-[460px] lg:min-h-[520px]">
            <Image
            ...
            <div className="absolute top-6 left-6 flex items-center gap-2">
              <span className="px-4 py-1.5 rounded-full bg-[#EA580C] text-white font-bold text-xs uppercase tracking-widest shadow-lg shadow-[#EA580C]/50">
                COMING SOON
              </span>
              <span className="px-3.5 py-1.5 rounded-full bg-black/60 backdrop-blur-md border border-white/20 text-xs font-semibold text-amber-300">
                {pachmarhi.seasonTag}
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 p-8 sm:p-12 flex flex-col justify-between space-y-6">
            ...
            <div className="pt-4 border-t border-white/10 flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-white/10 border border-white/15 text-xs font-semibold text-white cursor-not-allowed opacity-80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {otherConcepts.map((item) => (
            <motion.div
              ...
              className="rounded-3xl overflow-hidden bg-[#0A2E4C]/35 border border-white/10 p-6 sm:p-8 flex flex-col justify-between space-y-6 group"
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="px-3 py-1 rounded-full bg-[#EA580C]/20 border border-[#EA580C]/40 text-[11px] font-bold text-amber-300 uppercase tracking-widest">
                    COMING SOON
                  </span>
                ...
                <h4 className="text-2xl font-serif font-bold text-white group-hover:text-amber-200 transition-colors">
                  {item.title}
                </h4>

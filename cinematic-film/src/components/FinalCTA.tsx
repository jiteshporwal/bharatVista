...
import { Bus, ArrowRight, Sparkles, MapPin, Gift } from "lucide-react";
    ...
    <section className="relative py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-8">
          ...
          {/* Route Summary Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-black/40 border border-white/15 text-xs text-amber-200 font-mono flex-wrap justify-center">
            <MapPin className="w-3.5 h-3.5 text-[#EA580C]" />
            <span>Indore → Rau Circle → Jam Gate → Maheshwar → Shastradhara → Return by 8–9 PM • ₹{TRIP_CONFIG.price} All-Inclusive</span>
            <span>Indore → Rau Circle → Jam Gate → Maheshwar → Sahastradhara → Return by 8–9 PM • ₹{TRIP_CONFIG.price} All-Inclusive</span>
          </div>

          {/* Promotional Gift Notice */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/20 border border-amber-400/40 text-amber-300 text-xs font-mono">

    ...
    <div className="min-h-screen bg-[#061727] text-[#FFFDF9] flex flex-col justify-between selection:bg-[#EA580C] selection:text-white relative overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 z-10">
        <div className="w-full max-w-md">
          <div className="rounded-3xl p-6 sm:p-8 bg-[#0A2E4C]/40 border border-white/15 shadow-2xl backdrop-blur-md space-y-6">
            {/* Title & Badge */}
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/15 focus:border-[#EA580C] focus:outline-none text-white text-sm placeholder:text-zinc-500 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-11 rounded-xl bg-white/5 border border-white/15 focus:border-[#EA580C] focus:outline-none text-white text-sm placeholder:text-zinc-500 transition-colors"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 rounded-xl font-semibold text-sm text-white bg-gradient-to-r from-[#EA580C] to-[#C2410C] hover:from-[#f97316] hover:to-[#ea580c] shadow-lg shadow-[#EA580C]/30 flex items-center justify-center gap-2 cursor-pointer transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <>

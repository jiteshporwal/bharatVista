    ...
    <div className="min-h-screen bg-[#061727] text-[#FFFDF9] overflow-x-hidden selection:bg-[#EA580C] selection:text-white">
      ...
      <main className="pt-32 pb-24">
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center space-y-6">
          ...
          <p className="text-2xl sm:text-3xl font-serif text-amber-300 italic font-medium">
            &ldquo;{TRIP_CONFIG.tagline}&rdquo;
          </p>

          <p className="text-lg sm:text-xl text-zinc-300 font-light max-w-3xl mx-auto leading-relaxed pt-2">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-3xl p-8 bg-[#0A2E4C]/40 border border-white/10 space-y-4">
            ...
            <div className="rounded-3xl p-8 bg-[#0A2E4C]/40 border border-white/10 space-y-4">
              ...
              <h3 className="text-2xl font-serif font-bold text-white">Dhamal</h3>
              <p className="text-sm text-zinc-300 leading-relaxed font-light">
            ...
            <div className="rounded-3xl p-8 bg-[#0A2E4C]/40 border border-white/10 space-y-4">
              ...
              <h3 className="text-2xl font-serif font-bold text-white">Sukoon</h3>
              <p className="text-sm text-zinc-300 leading-relaxed font-light">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <div className="relative rounded-3xl p-8 sm:p-14 bg-gradient-to-b from-[#0A2E4C] to-[#040e1a] border border-amber-400/30 shadow-2xl space-y-8">
